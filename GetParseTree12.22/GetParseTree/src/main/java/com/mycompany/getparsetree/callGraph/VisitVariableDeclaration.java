...
public class VisitVariableDeclaration extends VoidVisitorAdapter<Object>{
	...
	private HashMap<String,String> classVariableType = new HashMap<String,String>();//类内变量
	private LinkedList<String> ownImport = new LinkedList<String>();//引用
	private String ownPackage;//包
	...
	private LinkedList<String> methodCallGraph = new LinkedList<String>();//调用图
